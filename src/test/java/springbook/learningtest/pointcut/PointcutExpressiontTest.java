 ...
 */
public class PointcutExpressiontTest {
    @Test
    public void methodSignaturePoint() throws Exception {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
        pointcut.setExpression("execution(public int springbook.learningtest"+
                ".spring.pointcut.Target.minus(int, int) throws java.lang.RuntimeException)");
    ...
    @Test
    public void simpleMethodSignaturePoint() throws Exception {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
